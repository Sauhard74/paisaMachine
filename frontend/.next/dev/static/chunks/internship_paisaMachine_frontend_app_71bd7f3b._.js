...
function loadWatchlist() {
    ...
    try {
        ...
        return parsed.filter((t)=>typeof t === "string" && /^[A-Z0-9&.\-]{1,20}$/.test(t));
    } catch  {
        return [];
    }
}
...
/* thin green drag handle */ function ResizeH() {
    ...
    if ($[0] !== "ebeeb970d5c7e0421e96131227bcf5f6372628e22ba34fbd6034307765b3b70d") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ebeeb970d5c7e0421e96131227bcf5f6372628e22ba34fbd6034307765b3b70d";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
//# sourceMappingURL=internship_paisaMachine_frontend_app_71bd7f3b._.js.map